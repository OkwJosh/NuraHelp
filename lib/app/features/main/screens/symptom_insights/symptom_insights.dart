...
import 'package:nurahelp/app/modules/patient/views/symptom_insights/symptom_insights_shimmer.dart';
...
class SymptomInsightsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<SymptomInsightController>();

    return Obx(() {
      if (controller.isLoading.value) {
        return const SymptomInsightsShimmer();
      }
      ...
      return Scaffold(
        ...
        body: RefreshIndicator(
          ...
          onRefresh: () => controller.refreshSymptomData(),
                      ...
                      children: [
                        ...
                        Obx(
                          () => ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              final symptom = controller.uniqueSymptoms[index];
                        ...
                        Row(
                          ...
                          children: [
                            OutlinedButton.icon(
                              onPressed: () =>
                                  addNewSymptom(context, controller),
                              icon: const Icon(
                                Icons.add,
                                color: AppColors.secondaryColor,
                              ),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              //       controller.isMonthlyView.value =
                              //           (option == 2);
                        ...
                        SymptomTrendChart(controller: controller),
                        const SizedBox(height: 5),
                        _buildTrendLegend(context, controller: controller),
                      ],
                    ),
                  ),
                ),
    ...
    return Obx(
      () => GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          // Get color synchronously - assignColorForSymptom ensures it exists
          final color = controller.assignColorForSymptom(symptom);
